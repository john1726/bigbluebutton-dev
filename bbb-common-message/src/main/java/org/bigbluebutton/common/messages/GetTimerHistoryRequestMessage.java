...
public class GetTimerHistoryRequestMessage implements IBigBlueButtonMessage {
	...
	public GetTimerHistoryRequestMessage(String meetingId, String requesterId, String replyTo) {
	...
	public static GetTimerHistoryRequestMessage fromJson(String message) {
			...
			if (header.has("name")) {
				...
				if (GET_TIMER_HISTORY_REQUEST.equals(messageName)) {
					...
					if (payload.has(Constants.MEETING_ID) 
						...
						return new GetTimerHistoryRequestMessage(meetingId, requesterId, replyTo);
					}
				} 
			}
		}
